...
<div class="container">
    <div class="content">
        ...
        <a href="<?php echo base_url('material/layouts/gone-home') ?>"><img src="<?php echo base_url('img/material/layout/gone.png') ?>" class="border"></a>

        <br><br>

        <h2>Fluff</h2>
        <p>Simple one-post-per-page theme with a polar beard.</p>
        <a href="<?php echo base_url('material/layouts/fluff') ?>"><img src="<?php echo base_url('img/material/layout/fluff.jpg') ?>" class="border"></a>

        <br><br>

        <h2>Neighbour</h2>
        <p>Simple white blog theme with a banner image.</p>
        <a href="<?php echo base_url('material/layouts/neighbour') ?>"><img src="<?php echo base_url('img/material/layout/neighbour.png') ?>" class="border"></a>

        <br><br>

        <h2>Hyperion</h2>
        <p>A simple one-column blog layout in a space theme.</p>
        <a href="<?php echo base_url('material/layouts/hyperion') ?>"><img src="<?php echo base_url('img/material/layout/hyperion.png') ?>" class="border"></a>

        <br><br>

        <h2>Feed Me</h2>
        <p>A colorful one-column layout in shape of a cat.</p>
        <a href="<?php echo base_url('material/layouts/feed-me') ?>"><img src="<?php echo base_url('img/material/layout/feedme.png') ?>" class="border"></a>

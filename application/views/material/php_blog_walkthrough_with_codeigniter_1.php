...
<li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>">Chapter 2</a>
    <ul>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>#part-5-template" aria-hidden="true" >Part 5: Template</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>#part-6-edit-posts" aria-hidden="true" >Part 6: Edit Posts</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>#part-7-pagination" aria-hidden="true" >Part 7: Pagination</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>#part-8-home-page" aria-hidden="true" >Part 8: Home page</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>#part-8-comments" aria-hidden="true" >Part 8: Comments</a></li>
    </ul>
</li>
<li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/3/') ?>">Chapter 3</a>
    <ul>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/3/') ?>#part-9-tags" aria-hidden="true" >Part 9: Tags</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/3/') ?>#part-10-deleting-posts" aria-hidden="true" >Part 10: Deleting Posts</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/3/') ?>#part-11-draft-posts" aria-hidden="true" >Part 11: Draft Posts</a></li>
        <li><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/3/') ?>#thats-it" aria-hidden="true" >That's it!</a></li>
    </ul>
</li>
</ul>
...
<div class="center"><b><a href="<?php echo base_url('material/php-blog-walkthrough-with-codeigniter/2/') ?>">To Chapter 2! &raquo;</a></b></div>

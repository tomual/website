...
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/index-html-file.png"></a>
...
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/page-without-bootstrap.png"></a>

<p>To link the Bootstrap style to the site we will link it in the head tag of the site.</p>

<textarea rows="9"><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.3/css/bootstrap.min.css" integrity="sha384-MIwDKRSSImVFAZCVLtU0LMDdON6KVCrZHyVQQj6e8wIEJkW4tvwqXrbMIya1vriY" crossorigin="anonymous"></textarea>
...
<textarea rows="9"><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.0.0/jquery.min.js" integrity="sha384-THPy051/pYDQGanwU6poAc/hOdQxjnOEXzbT+OuUAFqNqFjL+4IGLBgCJC3ZOShY" crossorigin="anonymous"></script>
...
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/page-with-bootstrap.png"></a>
...
<textarea rows="1"><link rel="stylesheet" type="text/css" href="style.css"></textarea>

<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/page-with-custom-bootstrap-styling.png"></a>
...
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/x10hostingi-cpanel-file-manager.png"></a>
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/reclaim-hosting-cpanel-file-manager.png"></a>
...
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/public-html-folder.png"></a>

<p>This is where our website files will go. Open the upload dialog and select the index.html and style.css files.</p>

<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/upload-to-public-html.png"></a>

<p>Go to your hosted site's URL. You should see your website.</p>

<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/x10hosting-page-example.png"></a>
...
<textarea rows="2">ns1.your-host.com
ns2.your-host.com</textarea>

<p>Below are examples of where to find nameservers - they are often found under domain settings.</p>

<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/x10hosting-nameservers.png"></a>
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/reclaim-hosting-nameservers.png"></a>
...
<a href=""><img src="<?php echo base_url() ?>images/extra/setting-up-a-website/namecheap-setting-nameserver.png"></a>

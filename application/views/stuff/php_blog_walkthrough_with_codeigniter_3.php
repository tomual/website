...
<div><b><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/2/') ?>">&laquo; Back to Chapter 2</a></b></div>
<br>
<h2>Table of Contents</h2>

<ul>
  <li><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/') ?>">Chapter 1</a></li>
  <li><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/2/') ?>">Chapter 2</a></li>
  <li>Chapter 3
      <ul>
          <li><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/3/') ?>#part-9-comments" aria-hidden="true" >Part 9: Comments</a></li>
          <li><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/3/') ?>#part-10-tags" aria-hidden="true" >Part 10: Tags</a></li>
          <li><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/3/') ?>#part-11-deleting-posts" aria-hidden="true" >Part 11: Deleting Posts</a></li>
          <li><a href="<?php echo base_url('stuff/php-blog-walkthrough-with-codeigniter/3/') ?>#part-12-draft-posts" aria-hidden="true" >Part 12: Draft Posts</a></li>
      </ul>
  </li>
</ul>
